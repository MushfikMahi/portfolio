...
import { FaProjectDiagram, FaEnvelope, FaArrowDown } from "react-icons/fa";
...
const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center text-white p-4 md:p-8"
    >
      <motion.div
      ...
      >
        ...
        >
          {["Frontend Developer", "Web Developer", "MERN Stack Devoloper"].map(
            (role, index) => (
              <motion.div
                key={index}
        ...
        <p className="text-sm md:text-lg mb-2 md:mb-4">
          I'm a Junior Web Devoloper. Problem solving is my passion. Interested
          with me? View my projects below then contact me.
        </p>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
          ...
          <motion.a
            ...
            transition={{ type: "spring", stiffness: 300 }}
          >
            <MdOutlineFileDownload className="mr-2 text-xl" /> My Resume
          </motion.a>
        </div>
      </motion.div>
      <motion.div
