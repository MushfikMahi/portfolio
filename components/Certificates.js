...
const certificates = [
  {
    ...
    images: ["/certificate/mushfik certificate.png"],
    description: "Certified by Programming-Hero",
  },
  {
    title: "Basic HTML, CSS & JS",
    images: ["/certificate/udemy certificate.png"],
          ...
          >
            <figure className="overflow-hidden flex items-center justify-center h-60">
              <img
                ...
                className="object-cover w-full h-full transition-all duration-300 hover:blur-sm"
              />
            </figure>
