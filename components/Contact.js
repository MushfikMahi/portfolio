  ...
  const handleSubmit = async (event) => {
    ...
    if (
      ...
      setAlert({
        ...
        type: "error",
        message:
          "Name must be between 2 and 100 characters, and contain only letters.",
      });
      return;
    }
  ...
  return (
    <section id="contact" className="container mx-auto py-20 px-4 md:px-0">
        ...
        >
          ...
          >
            ...
            <motion.textarea
              ...
              required
              className={`mt-1 block w-full rounded-lg bg-transparent bg-opacity-50 border-none border-b-2 text-white placeholder-gray-400 focus:outline-none transition duration-300 p-2 ${
                messageLength === 0
                  ? "border-white"
                  : messageLength < 20 || messageLength > 1000
                  ? "border-red-500"
                  : "border-green-500"
              }`}
              whileHover={{ scale: 1.02 }}
            ></motion.textarea>
            <span
              className={`absolute right-0 bottom-0 text-sm pr-2 pb-1 ${
                messageLength === 0
                  ? "text-white"
                  : messageLength < 20 || messageLength > 1000
                  ? "text-red-500"
      ...
      <div className="flex justify-center space-x-4 mt-8">
        <motion.a
          href="https://www.instagram.com/mushfik_mahi_"
          target="_blank"
        ...
        <motion.a
          href="https://www.facebook.com/mushfik.mahi.52"
          target="_blank"
          rel="noopener noreferrer"
          className="text-white"
          whileHover={{
        ...
        <motion.a
          href="https://github.com/MushfikMahi"
          target="_blank"
          rel="noopener noreferrer"
          className="text-white"
          whileHover={{
      ...
      <p className="text-lg mt-8 text-center">
        ...
        <a
          ...
          className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-pink-500 to-red-600"
        >
      ...
      <AnimatePresence>
        {alert.show && (
          <motion.div
            ...
            className={`fixed bottom-4 right-4 transform -translate-y-1/2 p-4 rounded-md shadow-md z-50 ${
              alert.type === "success"
