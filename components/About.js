      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            >
              Hello! My name is Mushfikus Salehin Mahi, but I usually go by
              Mahi. And i am a student of Govt. City Collage Chittagong
              currently living in Chittagong, Bangladesh. My interests range
            ...
            >
              I love creating interactive and responsive web applications. I'm
              dedicated to continuously improving my skills and keeping up with
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                ...
                <p>Student at Govt. City Collage Chittagong</p>
              </div>
            </motion.div>
            <motion.div
              className="glasseffect p-4 rounded-lg flex items-center hover:bg-opacity-75 hover:scale-105 transition-all duration-300"
